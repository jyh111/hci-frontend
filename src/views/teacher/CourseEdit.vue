...
import { FILE_BASE_PATH, downloadFile } from "@/api/file";
...
export default {
  ...
  methods: {
    ...
    download() {
      // downloadFile(this.currentEditFile.fileName).then(res => {
      //   console.log(res);
      //   this.alertMsg = "下载成功！";
      //   this.showAlert = true;
      //   this.dialog = false;
      ...
      // });
      // window.open(
      //   "/api/file/download?originName=" + this.currentEditFile.fileName
      // );
      var name = this.currentEditFile.fileName;
      const a = document.createElement("a");
      a.setAttribute("download", name);
      a.setAttribute("target", "_blank");
      a.setAttribute("href", "/api/file/download?originName=" + name);
      a.click();
      // window.location.href =
      //   `/file/download?originName=` + this.currentEditFile.fileName;
      // window.open(`${FILE_BASE_PATH}/${this.currentEditFile.fileName}`);
    }
  },
